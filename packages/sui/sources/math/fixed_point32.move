...
module legato_lbp::fixed_point32 {
    ...
    public fun sub(x: FixedPoint32, y: FixedPoint32): FixedPoint32 {
    ...
    public fun add(x: FixedPoint32, y: FixedPoint32): FixedPoint32 {
        let x_raw = get_raw_value(x);
        let y_raw = get_raw_value(y);
        let result = (x_raw as u128) + (y_raw as u128);
        assert!(result <= MAX_U64, ERATIO_OUT_OF_RANGE);
        create_from_raw_value((result as u64))
    }
    spec add {
        pragma opaque;
        aborts_if (x.value as u128) + (y.value as u128) > MAX_U64 with ERATIO_OUT_OF_RANGE;
        ensures result.value == x.value + y.value;
    }
    ...
    public fun less_or_equal(num1: FixedPoint32, num2: FixedPoint32): bool {
    ...
    spec fun spec_less_or_equal(num1: FixedPoint32, num2: FixedPoint32): bool {
        num1.value <= num2.value
    }
    ...
    spec fun spec_less(num1: FixedPoint32, num2: FixedPoint32): bool {
        num1.value < num2.value
    }

    /// Returns true if num1 >= num2
    public fun greater_or_equal(num1: FixedPoint32, num2: FixedPoint32): bool {
        num1.value >= num2.value
    }
    ...
    spec fun spec_greater_or_equal(num1: FixedPoint32, num2: FixedPoint32): bool {
        num1.value >= num2.value
    }

    /// Returns true if num1 > num2
    public fun greater(num1: FixedPoint32, num2: FixedPoint32): bool {
        num1.value > num2.value
    }
    spec greater {
        pragma opaque;
    ...
    spec fun spec_greater(num1: FixedPoint32, num2: FixedPoint32): bool {
        num1.value > num2.value
    }

    /// Returns true if num1 = num2
    public fun equal(num1: FixedPoint32, num2: FixedPoint32): bool {
        num1.value == num2.value
    }
    spec equal {
        pragma opaque;
    ...
    spec fun spec_equal(num1: FixedPoint32, num2: FixedPoint32): bool {
        num1.value == num2.value
    }
